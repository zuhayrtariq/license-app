            ...
            <form className='w-full' onSubmit={handleFormSubmit}>
              ...
              <div className='flex justify-between'>
                <div
                  ...
                  className='font-bold cursor-pointer underline text-white bg-red-500 outline  hover:text-white px-2 rounded-sm hover:outline-red-700'>
                  Delete
                </div>

                <button className='font-bold  underline text-green-400 outline hover:bg-green-400 hover:text-white px-2 rounded-sm hover:outline-green-700'>
                  Save
                </button>
              </div>
            </form>
