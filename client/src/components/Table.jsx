...
const Table = () => {
  ...
  //Date for the table
  const [section, setSection] = useState(tableId);
    ...
    <div className='justify-center  flex flex-col'>
      {formOpen && (
        <ContractDialog
          ...
          setNewRecordAdded={setNewRecordAdded}
          ...
          <div className='overflow-hidden'>
                ...
                {contractData?.map((contract, i) => {
                  return (
                    <tr
                      ...
                      {visibleCols.includes('Vendor Name') && (
                      ...
                      {visibleCols.includes('Contract Start Date') && (
                        <td className='whitespace-nowrap px-2 py-3'>
                          {formatDate(contract.contractStart)}
                        </td>
                      )}
                      {visibleCols.includes('Contract End Date') && (
                        <td className='whitespace-nowrap px-2 py-3'>
                          {formatDate(contract.contractEnd)}
                        </td>
                      )}
                      {visibleCols.includes('COFF Expiry') && (
                        <td>
                      ...
                      {visibleCols.includes('Contract Expiry') && (
                        <td>
                          <p className='capitalize'>
            ...
            <form
              ...
              <div className='flex w-full  '>
                {tableId ? (
                  <div className='  w-20 cursor-not-allowed whitespace-nowrap px-2 py-3 font-medium'>
                    ...
                    <input
                      ...
                      readOnly
                      value={section}
                      className='border-2 cursor-not-allowed w-full text-center  py-2 rounded-md px-1 placeholder:text-center placeholder:font-semibold placeholder:text-xs text-sm '
                      name=''
                      placeholder='Section'
                      id=''
                    />
                  ...
                  <div className='  w-20 focus-within:w-32 whitespace-nowrap px-2 py-3 font-medium'>
                    <h1 className='text-center font-semibold text-xs'>
                      Section
                    </h1>
